...
## DB Assignments  [![Build Status](https://travis-ci.org/N0menIllisLegio/db-assignments.svg?branch=master)](https://travis-ci.org/N0menIllisLegio/db-assignments)
...
```
* Open https://github.com/N0menIllisLegio/db-assignments and test the build icon. Now it will run all tests and update status once you push changes to github. Keep this icon green!
...
* Push your updates to github server and check if tests passed on [travis-ci](https://travis-ci.org/N0menIllisLegio/db-assignments/builds).
